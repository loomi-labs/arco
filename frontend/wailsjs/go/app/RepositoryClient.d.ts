...
export function GetArchiveMountStates(arg1:number):Promise<{[key: number]: types.MountState}>;
...
export function GetRepoMountState(arg1:number):Promise<types.MountState>;
...
export function UnmountRepository(arg1:number):Promise<types.MountState>;
