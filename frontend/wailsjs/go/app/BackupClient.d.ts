...
export function GetBackupProgress(arg1:types.BackupId):Promise<app.BackupProgressResponse>;

export function GetBackupProgresses(arg1:Array<types.BackupId>):Promise<Array<app.BackupProgressResponse>>;
