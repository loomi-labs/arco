 ...
 */
export function Update(repoId: number, updates: { [_: string]: any }): $CancellablePromise<$models.Repository | null> {
    return $Call.ByID(3450666087, repoId, updates).then(($result: any) => {
        return $$createType1($result);
    });
}
...
const $$createType10 = $models.QueuedOperation.createFrom;
const $$createType11 = $Create.Nullable($$createType10);
const $$createType12 = $Create.Array($$createType11);
const $$createType13 = $models.PaginatedArchivesResponse.createFrom;
const $$createType14 = $Create.Nullable($$createType13);
const $$createType15 = $models.PruningDates.createFrom;
const $$createType16 = platform$0.MountState.createFrom;
const $$createType17 = $Create.Nullable($$createType16);
const $$createType18 = $Create.Array($Create.Any);
const $$createType19 = $models.TestRepoConnectionResult.createFrom;
