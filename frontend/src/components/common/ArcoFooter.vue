          ...
          <div class="text-sm">
            ...
            <div class="flex flex-col gap-2">
              ...
              <div class="text-xs flex items-center gap-1">
                ...
                <a @click="BrowserOpenURL('mailto:mail@arco-backup.com')" class="link link-info cursor-pointer">mail@arco-backup.com</a>
              ...
              <div>
                ...
                <ul class="text-xs opacity-80 list-disc list-inside">
                  ...
                  <li>2 cups of <a @click="BrowserOpenURL('https://vuejs.org/')" class="font-bold link link-info cursor-pointer">Vue 3</a>, freshly brewed</li>
                  <li>A splash of <a @click="BrowserOpenURL('https://tailwindcss.com/')" class="font-bold link link-info cursor-pointer">Tailwind CSS</a> with <a @click="BrowserOpenURL('https://daisyui.com/')" class="font-bold link link-info cursor-pointer">daisyUI</a></li>
                  <li>A sprinkle of <a @click="BrowserOpenURL('https://entgo.io/')" class="font-bold link link-info cursor-pointer">Ent ORM</a> for data persistence</li>
                  <li>Stored in a <span class="font-bold">SQLite</span> jar</li>
                  <li><a @click="BrowserOpenURL('https://www.borgbackup.org/')" class="font-bold link link-info cursor-pointer">BorgBackup</a> as the secret sauce</li>
                  <li>Baked with <a @click="BrowserOpenURL('https://wails.io/')" class="font-bold link link-info cursor-pointer">Wails</a> to create a native experience</li>
                </ul>
              </div>
            </div>
          </div>
