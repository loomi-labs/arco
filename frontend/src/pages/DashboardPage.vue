...
const showStartupModal = ref<boolean>(false);
...
async function getData() {
  try {
    ...
    showStartupModal.value = backupProfiles.value.length === 0 && repos.value.length === 0;
  } catch (error: any) {
...
<template>
  ...
  <TransitionRoot as='template' :show='showStartupModal'>
    <Dialog class='relative z-10' @close='showStartupModal = false'>
              ...
              <div class='flex p-8'>
                <div class='pl-4'>
                  <div class='flex flex-col items-center text-center gap-1'>
                    ...
                    <p class='pt-2'>If you used <span class='font-semibold'>Arco</span> or <span class='font-semibold'>Borg Backup</span> before you can add your previous <span class='font-semibold'>Repositories</span>.</p>
                    <div class='pt-4'>
                      <button type='button' class='btn btn-sm btn-success' @click='showStartupModal = false'>Okay let's start</button>
                    </div>
                  </div>
                </div>
              </div>
