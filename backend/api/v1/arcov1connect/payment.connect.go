...
const (
	...
	PaymentServiceName = "arco.v1.PaymentService"
)
...
const (
	...
	PaymentServiceAddPaymentMethodProcedure = "/arco.v1.PaymentService/AddPaymentMethod"
	// PaymentServiceListPaymentMethodsProcedure is the fully-qualified name of the PaymentService's
	// ListPaymentMethods RPC.
	PaymentServiceListPaymentMethodsProcedure = "/arco.v1.PaymentService/ListPaymentMethods"
	// PaymentServiceGetPaymentHistoryProcedure is the fully-qualified name of the PaymentService's
	// GetPaymentHistory RPC.
	PaymentServiceGetPaymentHistoryProcedure = "/arco.v1.PaymentService/GetPaymentHistory"
)

// PaymentServiceClient is a client for the arco.v1.PaymentService service.
...
// NewPaymentServiceClient constructs a client for the arco.v1.PaymentService service. By default,
...
// AddPaymentMethod calls arco.v1.PaymentService.AddPaymentMethod.
...
// ListPaymentMethods calls arco.v1.PaymentService.ListPaymentMethods.
...
// GetPaymentHistory calls arco.v1.PaymentService.GetPaymentHistory.
...
// PaymentServiceHandler is an implementation of the arco.v1.PaymentService service.
...
func NewPaymentServiceHandler(svc PaymentServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/arco.v1.PaymentService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPaymentServiceHandler) AddPaymentMethod(context.Context, *connect.Request[v1.AddPaymentMethodRequest]) (*connect.Response[v1.AddPaymentMethodResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("arco.v1.PaymentService.AddPaymentMethod is not implemented"))
}
...
func (UnimplementedPaymentServiceHandler) ListPaymentMethods(context.Context, *connect.Request[v1.ListPaymentMethodsRequest]) (*connect.Response[v1.ListPaymentMethodsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("arco.v1.PaymentService.ListPaymentMethods is not implemented"))
}
...
func (UnimplementedPaymentServiceHandler) GetPaymentHistory(context.Context, *connect.Request[v1.GetPaymentHistoryRequest]) (*connect.Response[v1.GetPaymentHistoryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("arco.v1.PaymentService.GetPaymentHistory is not implemented"))
}
