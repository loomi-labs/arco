...
const (
	...
	SubscriptionServiceName = "arco.v1.SubscriptionService"
)
...
const (
	...
	// ListPlans RPC.
	SubscriptionServiceListPlansProcedure = "/arco.v1.SubscriptionService/ListPlans"
	// SubscriptionServiceGetSubscriptionProcedure is the fully-qualified name of the
	// SubscriptionService's GetSubscription RPC.
	SubscriptionServiceGetSubscriptionProcedure = "/arco.v1.SubscriptionService/GetSubscription"
	...
	SubscriptionServiceCreateCheckoutSessionProcedure = "/arco.v1.SubscriptionService/CreateCheckoutSession"
	...
	SubscriptionServiceCancelSubscriptionProcedure = "/arco.v1.SubscriptionService/CancelSubscription"
)

// SubscriptionServiceClient is a client for the arco.v1.SubscriptionService service.
...
// NewSubscriptionServiceClient constructs a client for the arco.v1.SubscriptionService service. By
...
func NewSubscriptionServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SubscriptionServiceClient {
	...
	subscriptionServiceMethods := v1.File_v1_subscription_proto.Services().ByName("SubscriptionService").Methods()
...
// ListPlans calls arco.v1.SubscriptionService.ListPlans.
...
// GetSubscription calls arco.v1.SubscriptionService.GetSubscription.
...
// CreateCheckoutSession calls arco.v1.SubscriptionService.CreateCheckoutSession.
...
// CancelSubscription calls arco.v1.SubscriptionService.CancelSubscription.
...
// SubscriptionServiceHandler is an implementation of the arco.v1.SubscriptionService service.
...
func NewSubscriptionServiceHandler(svc SubscriptionServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/arco.v1.SubscriptionService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSubscriptionServiceHandler) ListPlans(context.Context, *connect.Request[v1.ListPlansRequest]) (*connect.Response[v1.ListPlansResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("arco.v1.SubscriptionService.ListPlans is not implemented"))
}
...
func (UnimplementedSubscriptionServiceHandler) GetSubscription(context.Context, *connect.Request[v1.GetSubscriptionRequest]) (*connect.Response[v1.GetSubscriptionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("arco.v1.SubscriptionService.GetSubscription is not implemented"))
}
...
func (UnimplementedSubscriptionServiceHandler) CreateCheckoutSession(context.Context, *connect.Request[v1.CreateCheckoutSessionRequest]) (*connect.Response[v1.CreateCheckoutSessionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("arco.v1.SubscriptionService.CreateCheckoutSession is not implemented"))
}
...
func (UnimplementedSubscriptionServiceHandler) CancelSubscription(context.Context, *connect.Request[v1.CancelSubscriptionRequest]) (*connect.Response[v1.CancelSubscriptionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("arco.v1.SubscriptionService.CancelSubscription is not implemented"))
}
