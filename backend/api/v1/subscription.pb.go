...
const (
	...
	ChangeType_CHANGE_TYPE_PLAN_CHANGE ChangeType = 1
	// Currency change for billing.
	// Changes the currency used for billing (USD, EUR, CHF).
	ChangeType_CHANGE_TYPE_CURRENCY_CHANGE ChangeType = 2
	// Billing cycle change.
	// Changes between monthly and yearly billing cycles.
	ChangeType_CHANGE_TYPE_BILLING_CYCLE_CHANGE ChangeType = 3
)
...
var (
	ChangeType_name = map[int32]string{
		...
		1: "CHANGE_TYPE_PLAN_CHANGE",
		2: "CHANGE_TYPE_CURRENCY_CHANGE",
		3: "CHANGE_TYPE_BILLING_CYCLE_CHANGE",
	}
...
func (ChangeType) Descriptor() protoreflect.EnumDescriptor {
	return file_api_v1_subscription_proto_enumTypes[2].Descriptor()
}

func (ChangeType) Type() protoreflect.EnumType {
	return &file_api_v1_subscription_proto_enumTypes[2]
}
...
type PendingChangeStatus int32

const (
	// Default unspecified status.
	PendingChangeStatus_PENDING_CHANGE_STATUS_UNSPECIFIED PendingChangeStatus = 0
	// Change is scheduled and waiting to be applied.
	// Will take effect at the scheduled effective date.
	PendingChangeStatus_PENDING_CHANGE_STATUS_PENDING PendingChangeStatus = 1
	// Change has been successfully applied.
	// The subscription has been updated with the new values.
	PendingChangeStatus_PENDING_CHANGE_STATUS_APPLIED PendingChangeStatus = 2
	// Change has been canceled before taking effect.
	// The subscription will not be modified.
	PendingChangeStatus_PENDING_CHANGE_STATUS_CANCELED PendingChangeStatus = 3
)

// Enum value maps for PendingChangeStatus.
var (
	PendingChangeStatus_name = map[int32]string{
		0: "PENDING_CHANGE_STATUS_UNSPECIFIED",
		1: "PENDING_CHANGE_STATUS_PENDING",
		2: "PENDING_CHANGE_STATUS_APPLIED",
		3: "PENDING_CHANGE_STATUS_CANCELED",
	}
	PendingChangeStatus_value = map[string]int32{
...
func (x PendingChangeStatus) Enum() *PendingChangeStatus {
	p := new(PendingChangeStatus)
	*p = x
	return p
}

func (x PendingChangeStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PendingChangeStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_api_v1_subscription_proto_enumTypes[3].Descriptor()
}

func (PendingChangeStatus) Type() protoreflect.EnumType {
	return &file_api_v1_subscription_proto_enumTypes[3]
}

func (x PendingChangeStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PendingChangeStatus.Descriptor instead.
func (PendingChangeStatus) EnumDescriptor() ([]byte, []int) {
...
type ScheduleSubscriptionUpdateResponse struct {
	...
	ChangeId int64 `protobuf:"varint,3,opt,name=change_id,json=changeId,proto3" json:"change_id,omitempty"`
}
...
func (x *ScheduleSubscriptionUpdateResponse) GetChangeId() int64 {
	if x != nil {
		return x.ChangeId
	}
	return 0
...
type PendingChange struct {
	...
	ChangeType ChangeType `protobuf:"varint,2,opt,name=change_type,json=changeType,proto3,enum=api.v1.ChangeType" json:"change_type,omitempty"`
	...
	OldValue isPendingChange_OldValue `protobuf_oneof:"old_value"`
	...
	NewValue isPendingChange_NewValue `protobuf_oneof:"new_value"`
	...
	Status PendingChangeStatus `protobuf:"varint,10,opt,name=status,proto3,enum=api.v1.PendingChangeStatus" json:"status,omitempty"`
...
func (x *PendingChange) GetChangeType() ChangeType {
	if x != nil {
		return x.ChangeType
	}
...
func (m *PendingChange) GetOldValue() isPendingChange_OldValue {
	if m != nil {
		return m.OldValue
	}
	return nil
...
func (x *PendingChange) GetOldPlanId() string {
	if x, ok := x.GetOldValue().(*PendingChange_OldPlanId); ok {
		return x.OldPlanId
	}
	return ""
}

func (x *PendingChange) GetOldCurrency() Currency {
	if x, ok := x.GetOldValue().(*PendingChange_OldCurrency); ok {
		return x.OldCurrency
	}
	return Currency_CURRENCY_UNSPECIFIED
}

func (x *PendingChange) GetOldIsYearlyBilling() bool {
	if x, ok := x.GetOldValue().(*PendingChange_OldIsYearlyBilling); ok {
		return x.OldIsYearlyBilling
	}
	return false
}

func (m *PendingChange) GetNewValue() isPendingChange_NewValue {
	if m != nil {
		return m.NewValue
	}
	return nil
...
func (x *PendingChange) GetNewPlanId() string {
	if x, ok := x.GetNewValue().(*PendingChange_NewPlanId); ok {
		return x.NewPlanId
	}
	return ""
}

func (x *PendingChange) GetNewCurrency() Currency {
	if x, ok := x.GetNewValue().(*PendingChange_NewCurrency); ok {
		return x.NewCurrency
	}
	return Currency_CURRENCY_UNSPECIFIED
}

func (x *PendingChange) GetNewIsYearlyBilling() bool {
	if x, ok := x.GetNewValue().(*PendingChange_NewIsYearlyBilling); ok {
		return x.NewIsYearlyBilling
	}
	return false
}
...
func (x *PendingChange) GetStatus() PendingChangeStatus {
	if x != nil {
		return x.Status
	}
	return PendingChangeStatus_PENDING_CHANGE_STATUS_UNSPECIFIED
}
...
type isPendingChange_OldValue interface {
	isPendingChange_OldValue()
}

type PendingChange_OldPlanId struct {
	// Current plan ID (for plan changes).
	OldPlanId string `protobuf:"bytes,3,opt,name=old_plan_id,json=oldPlanId,proto3,oneof"`
}

type PendingChange_OldCurrency struct {
	// Current currency (for currency changes).
	OldCurrency Currency `protobuf:"varint,4,opt,name=old_currency,json=oldCurrency,proto3,enum=api.v1.Currency,oneof"`
}

type PendingChange_OldIsYearlyBilling struct {
	// Current yearly billing setting (for billing cycle changes).
	OldIsYearlyBilling bool `protobuf:"varint,5,opt,name=old_is_yearly_billing,json=oldIsYearlyBilling,proto3,oneof"`
}

func (*PendingChange_OldPlanId) isPendingChange_OldValue() {}

func (*PendingChange_OldCurrency) isPendingChange_OldValue() {}

func (*PendingChange_OldIsYearlyBilling) isPendingChange_OldValue() {}

type isPendingChange_NewValue interface {
	isPendingChange_NewValue()
}

type PendingChange_NewPlanId struct {
	// New plan ID (for plan changes).
	NewPlanId string `protobuf:"bytes,6,opt,name=new_plan_id,json=newPlanId,proto3,oneof"`
}

type PendingChange_NewCurrency struct {
	// New currency (for currency changes).
	NewCurrency Currency `protobuf:"varint,7,opt,name=new_currency,json=newCurrency,proto3,enum=api.v1.Currency,oneof"`
}

type PendingChange_NewIsYearlyBilling struct {
	// New yearly billing setting (for billing cycle changes).
	NewIsYearlyBilling bool `protobuf:"varint,8,opt,name=new_is_yearly_billing,json=newIsYearlyBilling,proto3,oneof"`
}

func (*PendingChange_NewPlanId) isPendingChange_NewValue() {}

func (*PendingChange_NewCurrency) isPendingChange_NewValue() {}

func (*PendingChange_NewIsYearlyBilling) isPendingChange_NewValue() {}
...
func (x *CancelPendingChangeRequest) GetChangeId() int64 {
	if x != nil {
		return x.ChangeId
	}
	return 0
...
var file_api_v1_subscription_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x03, 0x52, 0x08, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x49, 0x64, 0x22, 0x43, 0x0a,
	...
	0xbd, 0x04, 0x0a, 0x0d, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x43, 0x68, 0x61, 0x6e, 0x67,
	0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69,
	0x64, 0x12, 0x33, 0x0a, 0x0b, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65,
	...
	0x67, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x6f, 0x6c, 0x64, 0x5f, 0x70, 0x6c,
	0x61, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x09, 0x6f,
	0x6c, 0x64, 0x50, 0x6c, 0x61, 0x6e, 0x49, 0x64, 0x12, 0x35, 0x0a, 0x0c, 0x6f, 0x6c, 0x64, 0x5f,
	...
	,
	...
	0x65, 0x44, 0x61, 0x74, 0x65, 0x12, 0x33, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
	0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x50,
	0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x53, 0x74, 0x61, 0x74,
	...
	,
	...
	0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x22, 0x0a, 0x1e, 0x53, 0x55, 0x42, 0x53,
	0x43, 0x52, 0x49, 0x50, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f,
	0x49, 0x4e, 0x43, 0x4f, 0x4d, 0x50, 0x4c, 0x45, 0x54, 0x45, 0x10, 0x01, 0x12, 0x2a, 0x0a, 0x26,
	...
	,
	...
	0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x24, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x74, 0x0a, 0x19, 0x57, 0x61, 0x69, 0x74, 0x46, 0x6f,
	0x72, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74,
	0x69, 0x6f, 0x6e, 0x12, 0x28, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x57, 0x61, 0x69,
	0x74, 0x46, 0x6f, 0x72, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74, 0x43, 0x6f, 0x6d, 0x70,
	0x6c, 0x65, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x29, 0x2e,
	0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x57, 0x61, 0x69, 0x74, 0x46, 0x6f, 0x72, 0x43, 0x68,
	0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x6f, 0x6e, 0x12, 0x21, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x61, 0x6e, 0x63,
	...
	,
	...
	0x61, 0x6e, 0x63, 0x65, 0x6c, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x43, 0x68, 0x61, 0x6e,
	0x67, 0x65, 0x12, 0x22, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x61, 0x6e, 0x63,
	0x65, 0x6c, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x23, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e,
	0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x43, 0x68, 0x61,
	0x6e, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x8a, 0x01,
	0x0a, 0x0a, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x42, 0x11, 0x53, 0x75,
...
var file_api_v1_subscription_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_api_v1_subscription_proto_goTypes = []any{
	...
	(ChangeType)(0),                            // 2: api.v1.ChangeType
	(PendingChangeStatus)(0),                   // 3: api.v1.PendingChangeStatus
	...
	(*WaitForCheckoutCompletionRequest)(nil),   // 11: api.v1.WaitForCheckoutCompletionRequest
	(*WaitForCheckoutCompletionResponse)(nil),  // 12: api.v1.WaitForCheckoutCompletionResponse
	...
	(*UpgradeSubscriptionRequest)(nil),         // 15: api.v1.UpgradeSubscriptionRequest
	(*UpgradeSubscriptionResponse)(nil),        // 16: api.v1.UpgradeSubscriptionResponse
	(*ScheduleSubscriptionUpdateRequest)(nil),  // 17: api.v1.ScheduleSubscriptionUpdateRequest
	(*ScheduleSubscriptionUpdateResponse)(nil), // 18: api.v1.ScheduleSubscriptionUpdateResponse
	(*GetPendingChangesRequest)(nil),           // 19: api.v1.GetPendingChangesRequest
	(*GetPendingChangesResponse)(nil),          // 20: api.v1.GetPendingChangesResponse
	(*PendingChange)(nil),                      // 21: api.v1.PendingChange
	(*CancelPendingChangeRequest)(nil),         // 22: api.v1.CancelPendingChangeRequest
	(*CancelPendingChangeResponse)(nil),        // 23: api.v1.CancelPendingChangeResponse
	(*timestamppb.Timestamp)(nil),              // 24: google.protobuf.Timestamp
	(*Plan)(nil),                               // 25: api.v1.Plan
	(Currency)(0),                              // 26: api.v1.Currency
}
var file_api_v1_subscription_proto_depIdxs = []int32{
	6,  // 0: api.v1.GetSubscriptionResponse.subscription:type_name -> api.v1.Subscription
	0,  // 1: api.v1.Subscription.status:type_name -> api.v1.SubscriptionStatus
	24, // 2: api.v1.Subscription.current_period_start:type_name -> google.protobuf.Timestamp
	24, // 3: api.v1.Subscription.current_period_end:type_name -> google.protobuf.Timestamp
	24, // 4: api.v1.Subscription.canceled_at:type_name -> google.protobuf.Timestamp
	24, // 5: api.v1.Subscription.created_at:type_name -> google.protobuf.Timestamp
	24, // 6: api.v1.Subscription.updated_at:type_name -> google.protobuf.Timestamp
	25, // 7: api.v1.Subscription.plan:type_name -> api.v1.Plan
	26, // 8: api.v1.Subscription.currency:type_name -> api.v1.Currency
	26, // 9: api.v1.CreateCheckoutSessionRequest.currency:type_name -> api.v1.Currency
	24, // 10: api.v1.CancelSubscriptionResponse.effective_date:type_name -> google.protobuf.Timestamp
	1,  // 11: api.v1.WaitForCheckoutCompletionResponse.status:type_name -> api.v1.CheckoutStatus
	24, // 12: api.v1.UpgradeSubscriptionResponse.effective_date:type_name -> google.protobuf.Timestamp
	26, // 13: api.v1.ScheduleSubscriptionUpdateRequest.currency:type_name -> api.v1.Currency
	24, // 14: api.v1.ScheduleSubscriptionUpdateResponse.effective_date:type_name -> google.protobuf.Timestamp
	21, // 15: api.v1.GetPendingChangesResponse.pending_changes:type_name -> api.v1.PendingChange
	2,  // 16: api.v1.PendingChange.change_type:type_name -> api.v1.ChangeType
	26, // 17: api.v1.PendingChange.old_currency:type_name -> api.v1.Currency
	26, // 18: api.v1.PendingChange.new_currency:type_name -> api.v1.Currency
	24, // 19: api.v1.PendingChange.effective_date:type_name -> google.protobuf.Timestamp
	3,  // 20: api.v1.PendingChange.status:type_name -> api.v1.PendingChangeStatus
	24, // 21: api.v1.PendingChange.created_at:type_name -> google.protobuf.Timestamp
	4,  // 22: api.v1.SubscriptionService.GetSubscription:input_type -> api.v1.GetSubscriptionRequest
	7,  // 23: api.v1.SubscriptionService.CreateCheckoutSession:input_type -> api.v1.CreateCheckoutSessionRequest
	11, // 24: api.v1.SubscriptionService.WaitForCheckoutCompletion:input_type -> api.v1.WaitForCheckoutCompletionRequest
	9,  // 25: api.v1.SubscriptionService.CancelSubscription:input_type -> api.v1.CancelSubscriptionRequest
	13, // 26: api.v1.SubscriptionService.ReactivateSubscription:input_type -> api.v1.ReactivateSubscriptionRequest
	15, // 27: api.v1.SubscriptionService.UpgradeSubscription:input_type -> api.v1.UpgradeSubscriptionRequest
	17, // 28: api.v1.SubscriptionService.ScheduleSubscriptionUpdate:input_type -> api.v1.ScheduleSubscriptionUpdateRequest
	19, // 29: api.v1.SubscriptionService.GetPendingChanges:input_type -> api.v1.GetPendingChangesRequest
	22, // 30: api.v1.SubscriptionService.CancelPendingChange:input_type -> api.v1.CancelPendingChangeRequest
	5,  // 31: api.v1.SubscriptionService.GetSubscription:output_type -> api.v1.GetSubscriptionResponse
	8,  // 32: api.v1.SubscriptionService.CreateCheckoutSession:output_type -> api.v1.CreateCheckoutSessionResponse
	12, // 33: api.v1.SubscriptionService.WaitForCheckoutCompletion:output_type -> api.v1.WaitForCheckoutCompletionResponse
	10, // 34: api.v1.SubscriptionService.CancelSubscription:output_type -> api.v1.CancelSubscriptionResponse
	14, // 35: api.v1.SubscriptionService.ReactivateSubscription:output_type -> api.v1.ReactivateSubscriptionResponse
	16, // 36: api.v1.SubscriptionService.UpgradeSubscription:output_type -> api.v1.UpgradeSubscriptionResponse
	18, // 37: api.v1.SubscriptionService.ScheduleSubscriptionUpdate:output_type -> api.v1.ScheduleSubscriptionUpdateResponse
	20, // 38: api.v1.SubscriptionService.GetPendingChanges:output_type -> api.v1.GetPendingChangesResponse
	23, // 39: api.v1.SubscriptionService.CancelPendingChange:output_type -> api.v1.CancelPendingChangeResponse
...
func file_api_v1_subscription_proto_init() {
	...
	file_api_v1_subscription_proto_msgTypes[17].OneofWrappers = []any{
		(*PendingChange_OldPlanId)(nil),
		(*PendingChange_OldCurrency)(nil),
		(*PendingChange_OldIsYearlyBilling)(nil),
		(*PendingChange_NewPlanId)(nil),
		(*PendingChange_NewCurrency)(nil),
		(*PendingChange_NewIsYearlyBilling)(nil),
	}
	type x struct{}
